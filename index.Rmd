...
`r print_logo("nullabor.png", who = c("dianne"), pos = 'right:100%;top:200%;')`

.fr[
## Spatial visualisation


`r print_logo("sugarbag.png", who = c("dianne"), pos = 'right:100%;top:200%;')`
...
`r print_logo("spinifex.png", who = c("dianne"), pos = 'right:100%;top:200%;')` `r print_logo("tourr.png", who = c("dianne"), pos = 'right:100%;top:200%;')`
...
`r print_logo("lookout.png", who = c("hyndman"), pos = 'right:100%;top:200%;')` `r print_logo("stray.png", who = c("hyndman"), pos = 'right:100%;top:200%;')` `r print_logo("oddwater.png", who = c("hyndman"), pos = 'right:100%;top:200%;')`
