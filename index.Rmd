...
```{r keywordcloud, fig.height = 7.5, fig.width = 16}
...
`r print_logo("spinifex.png", who = c("spyrison", "dianne"), pos = '')` `r print_logo("tourr.png", who = c("dianne", "wickham"), pos = '', monash = 'mx')`
...
<br>
Theoretical foundations & methodology in statistics and econometrics, mixed with <br>
.fr[
development of computational tools and translational research 
]
